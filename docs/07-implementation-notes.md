# Implementation notes — probed Paperclip CLI behaviour

Layer 2. The argument is in [01-thesis.md](01-thesis.md); the pipeline these notes constrain is in [03-architecture.md](03-architecture.md). Read this page only if you are changing Paperclip-touching code.
